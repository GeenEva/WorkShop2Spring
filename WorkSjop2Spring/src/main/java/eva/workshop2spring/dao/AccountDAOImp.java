...
import eva.workshop2spring.domain.*;
import eva.workshop2spring.domain.Account.AccountType;
import eva.workshop2spring.utility.*;
...
public class AccountDAOImp implements AccountDAO {
	...
	public List<Account> getAllAccounts() {
		...
		try (Connection conn = DatabaseConnectionXML.getConnection();
			...
			while (resultSet.next()) {
				...
				account.setAccountType(((AccountType)resultSet.getObject(2)));
	...
	public int createAccount(Account account) {
		...
		try (Connection conn = DatabaseConnectionXML.getConnection();
			...
			preparedStatement.setObject(1, account.getAccountType());
